...
class Runner(object):
    ...
    def run(self, suite):
        ...
        sys.stderr.write("_____ filtered_cases: {filtered_cases}\n")
        sys.stderr.flush()
        ...
        sys.stderr.write("_____ augmented_cases: {augmented_cases}\n")
        sys.stderr.flush()
        ...
        sys.stderr.write("_____ case_id_by_case: {case_id_by_case}\n")
        sys.stderr.flush()
